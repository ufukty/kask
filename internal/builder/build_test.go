...
func TestBuilder_renderWebPages(t *testing.T) {
	...
	_, dst := buildTestSite(t, "testdata/web", "/")
...
func TestBuilder_renderMarkdownPages(t *testing.T) {
	_, dst := buildTestSite(t, "testdata/markdown-content", "/")
...
func TestBuilder_renderMarkdownToc(t *testing.T) {
	_, dst := buildTestSite(t, "testdata/markdown-toc", "/")
...
func TestBuilder_recursiveTemplating(t *testing.T) {
	_, dst := buildTestSite(t, "testdata/recursive-templating", "/")
...
func TestBuilder_cssSplitting(t *testing.T) {
	_, dst := buildTestSite(t, "testdata/css-splitting", "https://kask.ufukty.com/")
...
func TestBuilder_assets(t *testing.T) {
	_, dst := buildTestSite(t, "testdata/assets", "/")
...
func TestBuilder_assetLinking(t *testing.T) {
	_, dst := buildTestSite(t, "testdata/asset-linking", "https://kask.ufukty.com/")
...
func TestBuilder_hiddenPagesDst(t *testing.T) {
	_, dst := buildTestSite(t, "testdata/hidden-pages", "/")
	got := files(dst)
	expected := []string{
		"404.html",
		"career.html",
